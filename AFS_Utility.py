...
class ErrorCode:
    ...
    class ADXF(Enum):
        ...
        E0042401 = ErrorInfo("E0042401", "multi-load partition. (load partition)")
        E9040804 = ErrorInfo("E9040804", "can't open file. (load partition)")
        ...
        E9040813 = ErrorInfo("E9040813", "'sj' is NULL. (ADXF_ReadSj32)")
        E9040816 = ErrorInfo("E9040816", "'adxf' is NULL. (ADXF_ReadNw32)")
        E9040817 = ErrorInfo("E9040817", "'nsct' is negative. (ADXF_ReadNw32)")
        E9040818 = ErrorInfo("E9040818", "'buf' is NULL. (ADXF_ReadNw32)")
        E9040821 = ErrorInfo("E9040821", "'sj' must be NULL. (ADXF_ReadNw32)")
        E0120401 = ErrorInfo("E0120401", "'buf' isn't 64-byte alignment. (ADXF_ReadNw)")
        E9040822 = ErrorInfo("E9040822", "'adxf' is NULL. (ADXF_Stop)")
        E9040823 = ErrorInfo("E9040823", "'adxf->stm' is NULL. (ADXF_Stop)")
        E2092301 = ErrorInfo("E2092301", "'adxf' is NULL. (ADXF_StopNw)")
        E2092302 = ErrorInfo("E2092302", "'adxf->stm' is NULL. (ADXF_StopNw)")
        E9040825 = ErrorInfo("E9040825", "'adxf' is NULL. (ADXF_Seek)")
        E9040826 = ErrorInfo("E9040826", "'type' is illegal. (ADXF_Seek)")
        E9040827 = ErrorInfo("E9040827", "'adxf' is NULL. (ADXF_Tell)")
        E9040828 = ErrorInfo("E9040828", "'adxf' is NULL. (ADXF_GetFsizeSct)")
    ...
    class ADXT(Enum):
        ...
        E0071301 = ErrorInfo("E0071301", "ADXT_EntryAfs: can't entry")
        E02080850 = ErrorInfo("E02080850", "ADXT_StartSeamless: parameter error")
        E02080851 = ErrorInfo("E02080851", "ADXT_SetSeamlessLp: parameter error")
        E02080852 = ErrorInfo("E02080852", "ADXT_StartFnameRangeLp: parameter error")
        E0405100 = ErrorInfo("E0405100", "ADXT_StartAfsLp: parameter error")
        E02080854 = ErrorInfo("E02080854", "ADXT_GetNumFiles: parameter error")
        E02080849 = ErrorInfo("E02080849", "ADXT_ResetEntry: parameter error")
